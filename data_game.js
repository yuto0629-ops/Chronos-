...
const MISSIONS = {
  ...
  village: {
    ...
    missions: [
      {
        id: 'village_m1',
        name: 'Village Gatekeeper',
        name_ja: '村の門番',
        difficulty: 'easy',
        rewardType: 'item',
        battleType: 'Basic',
        playerSlots: 3,
        description: '村の入口を守るモンク2人。\n手始めにちょうど良い相手。',
        enemies: [
          { classKey: 'monk', x: 16, y: 3, level: 2 },
          { classKey: 'monk', x: 18, y: 5, level: 2 },
        ],
      },
      {
        id: 'village_m2',
        name: 'Wandering Gladiator',
        name_ja: '流れの剣闘士',
        difficulty: 'medium',
        rewardType: 'add_skill',
        battleType: 'Basic',
        playerSlots: 3,
        description: '村に流れ着いた剣闘士たち。\n弓使いの援護に注意。',
        enemies: [
          { classKey: 'gladiator', x: 16, y: 2, level: 3 },
          { classKey: 'gladiator', x: 18, y: 4, level: 3 },
          { classKey: 'archer', x: 17, y: 6, level: 2 },
        ],
      },
      {
        id: 'village_m3',
        ...
        battleType: 'Basic',
        playerSlots: 3,
        description: '腕利きの賞金稼ぎ3人。\n近・遠・格闘の混成パーティ。',
        enemies: [
          { classKey: 'gladiator', x: 16, y: 2, level: 3 },
          { classKey: 'archer', x: 18, y: 4, level: 3 },
          { classKey: 'monk', x: 16, y: 6, level: 3 },
        ],
      },
      {
        id: 'village_m4',
        ...
        battleType: 'Basic',
        playerSlots: 3,
        description: '村を守護するチャンピオンと\nその護衛のモンク2人。強敵。',
        enemies: [
          { classKey: 'champion', x: 17, y: 2, level: 4 },
          { classKey: 'monk', x: 15, y: 4, level: 3 },
          { classKey: 'monk', x: 19, y: 4, level: 3 },
        ],
      },
    ],
  },
